...
def makeDataSampleFiles():
    ...
    basepath = "/store/group/lpcsuep/Scouting/Datav6/2018/ScoutingPFHT+Run2018A-v1+RAW/"#TreeMaker/Production/python/"
    #basepath = f"{cmssw_base}/src/brilcalc/"#TreeMaker/Production/python/"
