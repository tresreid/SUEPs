...
extern "C" {
  ...
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_int8(
    int8_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_int16(
    int16_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_int32(
    int32_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_int64(
    int64_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_uint8(
    uint8_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_uint16(
    uint16_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_uint32(
    uint32_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_uint64(
    uint64_t* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_float32(
    float* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_NumpyArray_unique_ranges_float64(
    double* toptr,
    const int64_t* offsets,
    int64_t offsetslength,
    int64_t* outoffsets,
  ...
  awkward_sort_ascending_uint64(
    ...
    int64_t parentslength);
  EXPORT_SYMBOL ERROR
  awkward_sort_ascending_float32(
    float* toptr,
    const float* fromptr,
    int64_t length,
    const int64_t* offsets,
    ...
    int64_t parentslength);
  EXPORT_SYMBOL ERROR
  awkward_sort_ascending_float64(
    double* toptr,
    const double* fromptr,
    int64_t length,
    const int64_t* offsets,
