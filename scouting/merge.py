...
outhists = outhists + ["HT1000_%s"%x for x in range(0,22)]
...
outhists = outhists + ["HT200_%s"%x for x in range(0,27)]
outhists = outhists + ["HT200_%s"%x for x in range(28,31)]
outhists = outhists + ["HT200_%s"%x for x in range(32,47)]
outhists = outhists + ["HT200_%s"%x for x in range(48,54)]
outhists = outhists + ["HT200_%s"%x for x in range(55,67)]
