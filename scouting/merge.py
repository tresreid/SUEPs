...
outhists = outhists + ["HT1000_%s"%x for x in range(2,22)]
outhists = outhists + ["HT700_%s"%x for x in range(0,54)]
outhists = outhists + ["HT500_%s"%x for x in range(0,70)]
outhists = outhists + ["HT300_%s"%x for x in range(0,64)]
#outhists = outhists + ["HT300_%s"%x for x in range(29,64)]
outhists = outhists + ["HT200_%s"%x for x in range(0,17)]
outhists = outhists + ["HT200_%s"%x for x in range(21,29)]
outhists = outhists + ["HT200_%s"%x for x in range(30,68)]
#outhists = outhists + ["HT200_%s"%x for x in range(32,46)]
#outhists = outhists + ["HT200_%s"%x for x in range(48,54)]
#outhists = outhists + ["HT200_%s"%x for x in range(55,61)]
#outhists = outhists + ["HT200_%s"%x for x in range(62,68)]
