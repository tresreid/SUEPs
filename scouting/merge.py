...
#"HT200_2",
#]
outhists = ["HT2000_%s"%x for x in range(1,9)]
outhists = outhists + ["HT1500_%s"%x for x in range(0,18)]
outhists = outhists + ["HT1000_%s"%x for x in range(0,6)]
outhists = outhists + ["HT1000_%s"%x for x in range(7,22)]
outhists = outhists + ["HT700_%s"%x for x in range(0,60)]
outhists = outhists + ["HT500_%s"%x for x in range(0,62)]
outhists = outhists + ["HT300_%s"%x for x in range(0,64)]
#outhists = outhists + ["HT300_%s"%x for x in range(29,64)]
outhists = outhists + ["HT200_%s"%x for x in range(0,1)]
outhists = outhists + ["HT200_%s"%x for x in range(3,16)]
outhists = outhists + ["HT200_%s"%x for x in range(18,19)]
outhists = outhists + ["HT200_%s"%x for x in range(21,22)]
outhists = outhists + ["HT200_%s"%x for x in range(24,27)]
outhists = outhists + ["HT200_%s"%x for x in range(28,31)]
outhists = outhists + ["HT200_%s"%x for x in range(33,43)]
outhists = outhists + ["HT200_%s"%x for x in range(44,46)]
outhists = outhists + ["HT200_%s"%x for x in range(48,51)]
outhists = outhists + ["HT200_%s"%x for x in range(52,63)]
outhists = outhists + ["HT200_%s"%x for x in range(64,67)]
#outhists = outhists + ["HT200_%s"%x for x in range(21,27)]
#outhists = outhists + ["HT200_%s"%x for x in range(28,31)]
#outhists = outhists + ["HT200_%s"%x for x in range(32,47)]
#outhists = outhists + ["HT200_%s"%x for x in range(48,68)]
