...
outhists = ["RunA_%s"%x for x in range(1,23)]
outhists = outhists+ ["RunA_%s"%x for x in range(24,27)]
outhists = outhists+ ["RunA_%s"%x for x in range(28,29)]
outhists = outhists+ ["RunA_%s"%x for x in range(30,36)]
outhists = outhists+ ["RunA_%s"%x for x in range(37,41)]
outhists = outhists+ ["RunA_%s"%x for x in range(42,57)]
